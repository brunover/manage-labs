...
class RegisterPeriod extends React.Component {
    ...
    return (
      <Base>
        <div className="view-internal reservas-view">
          <div id="page-title">
            <h1 className="page-header text-overflow">Turnos cadastrados</h1>
          </div>
          <ol className="breadcrumb">
            <li><Link to="/painel">Home</Link></li>
            <li><a href="#!">Cadastros</a></li>
            <li className="active">Turnos</li>
          </ol>
            ...
            <div className="mar-btm">
              <form className="form-inline form--personalized">
                <div className="input-group form-group">
                  ...
                  <input type="text" className="form-control" placeholder="Pesquisar Turnos" />
                </div> &nbsp;&nbsp;
                <div className="input-group form-group">
                ...
                <a data-target="#modalNewPeriod" data-toggle="modal" className="btn btn-info">Novo Turno</a>
              </form>
            </div>
                ...
                <tbody>
                  <tr className="text-dark">
                    ...
                    <td className="text-center">
                      <a data-target="#modalEditPeriod_1" data-toggle="modal" className="btn btn-info">Editar</a> &nbsp;
                      <a data-event="deleteCourse" className="btn btn-danger">Deletar</a>
                      <div className="modal fade" id="modalEditPeriod_1" role="dialog" tabIndex="-1" aria-labelledby="modalEditPeriod_1" aria-hidden="true">
                        <div className="modal-dialog">
                          <div className="modal-content">
                            <div className="modal-header">
                              <button type="button" className="close" data-dismiss="modal"><i className="pci-cross pci-circle"></i></button>
                              <h4 className="modal-title">Alterar Turno</h4>
                            </div>
        ...
        <div className="modal fade" id="modalNewPeriod" role="dialog" tabIndex="-1" aria-labelledby="modalNewPeriod" aria-hidden="true">
          <div className="modal-dialog">
            <div className="modal-content">
              <div className="modal-header">
                <button type="button" className="close" data-dismiss="modal"><i className="pci-cross pci-circle"></i></button>
                <h4 className="modal-title">Novo Turno</h4>
              </div>
              <div className="modal-body">
                <form className="form--personalized row">
                  <div className="col-md-6 form-group">
